...
import { AnyIndicator, FullDataset, MainIndicators } from "../models/FullDataset";
...
const SampleIndicatorCard: React.FC<SampleIndicatorCardProps> = props => {
    ...
    if (city && props.indicator?.includes('.')) {
        ...
        const subIdx = props.indicator.split('.')[1] as keyof typeof main.subIndicators;
    ...
    return (
        <Card 
            ...
            extra={<LinkBuilder componentName="sample" appRoute="/sample" params={{city: props.city, indicator: props.indicator}} />} 
            style={{maxWidth: '400px', width: '100%'}}
        >
